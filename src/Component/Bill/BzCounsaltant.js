...
const BzCounsaltant = () => {
    ...
    const downloadInvoice = () => {
        ...
        html2canvas(invoiceElement, {
            ...
            pdf.save('BzCounsaltant_invoice.pdf');
        }).catch((error) => {
        ...
        <div>
            ...
            >
                ...
                >
                    {/* Image */}
                    <img
                        src="https://res.cloudinary.com/dlwot6rlr/image/upload/v1724313409/Frame_26_ovt9xt.png" // Replace with the actual URL or local path
                        alt="Company Logo"
                        style={{
                            width: '205mm', // Adjust the width as needed
                            marginBottom: '0px'
                        }}
                    />
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0' }}>
                    ...
                    <div style={{ width: '38.5%', border: '1px solid black', padding: '10px' }}>
                        <p>
                            <strong>Total AMT. (Rs):</strong> {performa.tot.toLocaleString().toLocaleString()}
                        </p>
                    </div>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0' }}>
                    <div style={{ width: '75%', border: '1px solid black', padding: '10px' }}>
                        <p>
                            <strong> Bank Details :</strong> SBI BANK
                        </p>
                        <p>
                            <strong> A/c Name :</strong> BZ CONSULTANTS PVT LTD
                        </p>
                        <p>
                            <strong> A/C No. :</strong> 00000020520920801
                        </p>
                        <p>
                            <strong>IFSC CODE :</strong> SBIN0061658
                        </p>
                    </div>
                    <div style={{ width: '45%', border: '1px solid black', padding: '10px', height: '220px' }}>
                        <img
                            src="https://res.cloudinary.com/dlwot6rlr/image/upload/v1724414278/Screenshot_2024-08-23_172656_o8hzmu.png" // Replace with the actual URL or local path
                            alt="Company Logo"
                            style={{
                                borderRadius: '50%',
                                marginTop: '0px',
                    ...
                    <div style={{ width: '65%', border: '1px solid black', padding: '10px', textAlign: 'center' }}>
                        <p>
                            <strong>For BZ CONSULTANTS PVT LTD</strong>
                        </p>
                        <img
                            src="https://res.cloudinary.com/dlwot6rlr/image/upload/w_1000,ar_16:9,c_fill,g_auto,e_sharpen/v1724405265/Screenshot_2024-08-23_145523_wkmoxx.png" // Replace with the actual URL or local path
                            alt="Company Logo"
                            style={{
